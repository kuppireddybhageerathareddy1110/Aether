...
export default function UniversalSearch() {
  ...
  const search = async () => {
    ...
    try {
      ...
      setResults([
        { type: 'journal', content: `Found "${query}" in 3 journal entries. Most recent: "I discovered strong correlations..."`, mood: 'Curious' },
        { type: 'document', name: 'graph-neural-networks.pdf', content: `Semantic match score: 0.91. Key passage mentions "${query}" in context of betweenness centrality.` },
        { type: 'graph', name: 'Knowledge Graph #4', content: `Concept node "${query}" has 12 edges and centrality rank 3/87.` },
      ]);
    }
    setLoading(false);
  };
