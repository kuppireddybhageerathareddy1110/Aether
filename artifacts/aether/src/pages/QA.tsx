  ...
  const generate = async () => {
    ...
    try {
      ...
      setResult({
        query,
        test_cases: [
          { id: 1, scenario: 'Positive: Valid discount code applied', steps: ['Navigate to checkout', 'Enter code SAVE20', 'Verify 20% discount applied'] },
          { id: 2, scenario: 'Negative: Expired discount code', steps: ['Navigate to checkout', 'Enter code EXPIRED', 'Verify error message shown'] },
        ],
